...
const Tech = () => {
  return (
    <>
      <div className="overflow-y-scroll scrollBar overflow-x-hidden" style={{ maxHeight: '70vh' }}>
        <div className="space-y-2 pt-6 pb-8 md:space-y-5 mb-20 md:mb-10">
        ...
        >
          <div className="text-center">
            <h1 className='text-3xl font-bold text-black dark:text-white'>What I Use</h1>
          </div>
